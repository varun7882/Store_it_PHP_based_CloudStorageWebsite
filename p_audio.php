...
<html>
	...
	?>
    	...
    	history.pushState(null, null, 'p_audio.php');
		...
		<?php
			...
			if(isset($_POST["upload"]))
			{
				...
				{
					$message = "your media has not been uploaded\:too large file or incomprehensiable format";
					header("Location: login/homepage.php");
			...
			<div id="imgcontainer">
				<?php 
					$sql2="select count(media) from $uid";
					 ...
					 $c=$n["0"];
					 $sql3="select media from $uid where type='audio/mp3' or type='audio/aac'";
					...
					<div class="imgbox" id="<?php echo $img ?>" >
						<div class="img" >
						<img src='images/audio.jpg' class='img'>
						</div>																																															
						<div class="title">
						<?php  echo "<p align='center'>$img</p>" ?>
						</div>
					<div id="links" style="background:red;">
						 <p align="center">
					<a  href='<?php echo "uploads/$u/music/$img" ?>'  download>
						<div class="dbuttons">
						 		DOWNLOAD
						 	</div>
						 	</a> 
						 	<a  href='<?php echo "uploads/$u/music/$img" ?>' target="_blank" >
						 	<div  class="dbuttons">
						 		PLAY
						 	</div>
						 </a>
						 	<div class="dbuttons" id='<?php echo "uploads/$u/music/$img" ?>' onClick='del(this.id,"<?php echo $img ?>","<?php echo $uid ?>")'>
						 		DELETE
						 	</div>
						 	<div class="dbuttons" id='<?php echo "/uploads/$u/music/$img" ?>' onClick='share(this.id,"<?php echo $img ?>","<?php echo $u ?>")'>
						 		SHARE
						 	</div>
						 </p>
						</div>
