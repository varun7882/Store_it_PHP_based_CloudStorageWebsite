...
<html>
	...
	?>
    	...
    	history.pushState(null, null, 'p_docs.php');
			...
			<div id="imgcontainer">
				<?php 
					$sql2="select count(media) from $uid";
					 ...
					 $c=$n["0"];
					 $sql3="select media from $uid where type='application/pdf' or type='application/octet-stream'";
					...
					<div id="links" style="background:red;">
						 <p align="center">
					<a  href='<?php echo "uploads/$u/docs/$img" ?>'  download>
						<div class="dbuttons">
						 		DOWNLOAD
						 	</div>
						 	</a> 
						 	<a  href='<?php echo "uploads/$u/docs/$img" ?>' target="_blank" >
						 	<div  class="dbuttons">
						 		VIEW
						 	</div>
						 </a>
						 	<div class="dbuttons" id='<?php echo "uploads/$u/docs/$img" ?>' onClick='del(this.id,"<?php echo $img ?>","<?php echo $uid ?>")'>
						 		DELETE
						 	</div>
						 	<div class="dbuttons" id='<?php echo "/uploads/$u/docs/$img" ?>' onClick='share(this.id,"<?php echo $img ?>","<?php echo $u ?>")'>
						 		SHARE
						 	</div>
						 </p>
						</div>
