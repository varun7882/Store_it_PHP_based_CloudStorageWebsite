...
<html>
	...
	?>
    	...
    	history.pushState(null, null, 'p_video.php');
			...
			<div id="imgcontainer">
				<?php 
					$sql2="select count(media) from $uid";
					 ...
					 $c=$n["0"];
					 $sql3="select media from $uid where type='video/mp4' or type='video/avi'";
					...
					<div class="imgbox" id="<?php echo $img ?>" >
						<div class="img" >
						<img src='images/thumb.png' class='img'>
						</div>																																															
						<div class="title">
					...
					<div id="links" >
						 <p align="center">
					<a  href='<?php echo "uploads/$u/videos/$img" ?>'  download>
						<div class="dbuttons">
						 		DOWNLOAD
						 	</div>
						 	</a> 
						 	<a  href='<?php echo "uploads/$u/videos/$img" ?>' target="_blank" >
						 	<div  class="dbuttons">
						 		PLAY
						 	</div>
						 </a>
						 	<div class="dbuttons" id='<?php echo "uploads/$u/videos/$img" ?>' onClick='del(this.id,"<?php echo $img ?>","<?php echo $uid ?>")'>
						 		DELETE
						 	</div>
						 	<div class="dbuttons" id='<?php echo "/uploads/$u/videos/$img" ?>' onClick='share(this.id,"<?php echo $img ?>","<?php echo $u ?>")'>
						 		SHARE
						 	</div>
						 </p>
						</div>
